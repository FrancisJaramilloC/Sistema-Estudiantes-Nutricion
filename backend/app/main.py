...
from app.database import (
    ...
    get_or_create_audit_log_table, get_or_create_pairing_codes_table,
    seed_alimentos_if_empty, seed_users_if_empty,
)
from app.routes import health, plans, admin, auth, clinical, devices, alimentos, plan_nutricional, sugerencia, sessions
